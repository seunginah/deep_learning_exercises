...
class LinearClassifier(object):
  ...
  def predict(self, X):
    ...
    # get the inner product of X and trained weights (n_training x n_classes)
    # for each row (each has 10 columns = 10 scores), get the label with the max value score
    # y_pred has n_training rows, each contains the index of the column with the highest score (predicted label) 
